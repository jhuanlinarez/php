    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <?php
                    ...
                    echo "<br>Porque " . '$a' ." vale $a <br>";
                    echo 'e $b vale 4 <br>'; 
                    echo 'Primeiro parenteses: 3 + 2 (que é o valor do $a)<br>';
                    echo "resultado: ";
                    echo 3 + $a . "<br>"; 
                    echo 'Segundo parenteses: 5 x 4 (que é o valor do $b) == 20<br>';
                    echo "multiplicação: 5 * 4 == 20<br>";
                    echo "Agora a soma: 52 + 20 é 72<br>";
